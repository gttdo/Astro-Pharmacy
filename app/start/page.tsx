...
import { Stethoscope, FlaskConical, ArrowRight, ChevronLeft } from "lucide-react";
  ...
  return (
    <DeviceFrame>
      ...
      <div className="flex flex-1 flex-col px-7 pb-10">
        <button
          onClick={() => router.push("/")}
          className="mt-2 flex w-fit items-center gap-1 text-sm text-muted hover:text-ink"
        >
          <ChevronLeft size={18} /> Intro
        </button>
        ...
        <div className="flex flex-1 flex-col justify-center">
          ...
          <p className="mt-4 text-center text-xs text-muted">
            Tip: you can switch roles mid-flow to drive both sides of the
            verification loop.
          </p>
        </div>
